...
export const commands = {
	...
	async getListOfAllTagsWithDetails(
		orderingCriteria: AllTagsOrderingCriteria
...
export type AllTagsOrderingCriteria =
	| 'Alphabetic'
	| 'AlphabeticReverse'
	| 'TagCount'
	| 'TagCountReverse';
...
export type MediaInfo = {
	...
	paths: string[];
	tags: TagWithDetails[];
	sourceCategoryGroupedTags: SourceCategoryGroupedTags;
	rawTagsField: string;
	hash: string;
	mediaType: string;
	mime: string | null;
...
export type SourceCategoryGroupedTags = {
	source_categories: { [key in string]: HashTagPair[] };
	uncategorized: HashTagPair[];
};
/**
...
export type TagDetail = {
	 ...
	 */
	delete_on_no_references_left: boolean;
	color: string | null;
	group: string | null;
	/**
...
export type Thumbs = {
	...
	thumbs_db_path: string;
};
export type ThumbsDBInfo = {
	path: string;
	size: string;
	image_count: number;
	height: number;
